...
def main():
    ...
    if choice == '9':
        ...
        user_id = input('Enter the user_id of the particular user you are concerned with ')
        ...
        user_id = input('Enter the user_id of the particular user you are concerned with ')
        transaction_id = input('enter the user_id of the transaction you willing to find it distance from the centroid ')
        transaction_distance_from_centroid = user_statistics.distance_from_centroid(user_id, transaction_id)
        ...
        user_id = input('Enter the transaction_id of the particular transaction you are concerned with checking it fraud status ')
        fraud_status_transaction = user_statistics.transaction_status(user_id)
        print(fraud_status_transaction)
    elif choice == '7':
        user_id = input('Enter the user_id of the particular user who among their transactions you are concerned with getting the distance between two transaction of the user ')
        distance_transaction_user = user_statistics.distance_between_transaction_user(user_id)
        print(distance_transaction_user)
    elif choice =='8':
        user_id = input('Enter the user_id of the particular user who among their transactions you are concerned with using one of their transaction ')
        id2 = input('Enter the user_id of the particular user who among their transactions you are concerned with using one of their transaction ')
